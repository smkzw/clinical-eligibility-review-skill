...
- MG-K10-SAR-001 phase III has 16 official exclusion criteria. Its official EX-06 is one treatment-history package, not six separate criteria. Old generated IDs must be remapped as: old EX-06 to EX-11 aggregate into official EX-06; old EX-12 -> official EX-07; old EX-13 -> official EX-08; old EX-14 -> official EX-09; old EX-15 -> official EX-10; old EX-16 -> official EX-11; old EX-17 -> official EX-12; old EX-18 -> official EX-13; old EX-19 -> official EX-14; old EX-20 -> official EX-15; old EX-21 -> official EX-16.
- EX-06: medication/treatment-history package must include antihistamines, leukotriene receptor antagonists/mast-cell stabilizers, systemic corticosteroids/SAR Chinese medicine, asthma inhaled-corticosteroid stability exception, systemic immunosuppressants, biologics/monoclonal antibodies, prior MG-K10 trial, live/attenuated vaccine, immunotherapy, nasal/nasal-sinus surgery, and organ/hematopoietic/bone-marrow transplant history. Evidence focus must follow the specific subitem under review and must not highlight an adjacent EX-06 subitem merely because it appears earlier in the same paragraph.
- EX-06 subitem evidence must stay literal. Do not infer the antihistamine/leukotriene/mast-cell-stabilizer subitem from vague OCR wording such as `治疗AR的全身性抑制剂`. Do not match a project header containing `MG-K10`; the prior-trial subitem requires wording such as `既往未参加过MG-K10临床试验` or a direct prior-participation statement. If OCR splits `鼻窦手术` across pages, reconstruct the displayed quote from adjacent OCR pages instead of showing a truncated phrase.
...
- Do full-batch QC for evidence-gate regressions when changing report logic: no non-EX-16 pass may have zero displayable evidence; EX-16 may only show explicit unsuitable wording; EX-09 must not show headers, allergen legends, bare lab markers, or no-result EDC rows; EX-14 must not show unrelated TP/syphilis serology as pregnancy evidence. For MG-K10-SAR-001 three-center output, check 42 subjects and 966 rule cards/details.
